...
public class MazeTest extends JFrame implements GridColors {
    ...
    public void solve() {
        ...
        // Method to find all paths for problem 2
        // ArrayList<ArrayList<PairInt>> allPaths = m.findAllMazePaths(0, 0);
        // JOptionPane.showMessageDialog(null, allPaths);
       
        
        // Method to find the shortest path for problem 3
        // ArrayList<PairInt> minimum_path = m.findMazePathMin(0, 0);
        // JOptionPane.showMessageDialog(null, minimum_path); 
    }
}
