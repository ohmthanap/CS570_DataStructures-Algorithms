...
public class Treap<E extends Comparable<E>> {
    ...
    public static void main(String[] args) throws Exception {
		...
		// test for adding a node with the given key and priority into the treap
		testTree.add(4,19); 
		testTree.add(2,31);
		testTree.add(6,70); 
		testTree.add(1,84);
		...
		// test for deleting a node from the treap
